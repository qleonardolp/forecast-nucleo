...
int main() {
    forecast::App app;
    app.setLogger([](utility::ddvar, const forecast::Hardware* hw,
                     const forecast::Controller*, const forecast::Controller*) {
        return std::vector<float>{hw->getTauS(), hw->getTauM()};
    });
